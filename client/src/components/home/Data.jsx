  ...
  return (
    <>
        <div className="home__data">
            <h1 className="home__title">Jinumenasarma
                <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
            ...
            <h3 className="home__subtitle">Data Analysis</h3>
            <p className="home__description">I'm Data Analaysis based 
            in Sri Lanka, I'm very passionate and dedicated to my
            work.</p>
